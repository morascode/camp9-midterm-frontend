    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex gap-1 p-2 px-4 items-center">
        <svg
          ...
          strokeWidth="1.5"
          stroke=""
          className="w-10 h-10 fill-white-dimmed dark:stroke-dark"
        >
          <path
            strokeLinecap="round"
      ...
      <div className="flex gap-1 p-2 px-4 items-center">
        <svg
          ...
          strokeWidth="1.5"
          stroke="currentColor"
          className="w-10 h-10 stroke-white-dimmed dark:stroke-dark"
        >
          <path
            strokeLinecap="round"
            strokeLinejoin="round"
